...
let
  sources = {
    ...
    "@react-native-community/cli-1.9.7" = {
      ...
      version = "1.9.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/@react-native-community/cli/-/cli-1.9.7.tgz";
        sha512 = "3Fw0TxB8fOVKD51kK9NN/SIonkvl8iCuUGb01RuzsrnMS76Wiu5JY3H7NhhPdvxFrrqa3vgBqJWRowAxbGJqJg==";
      };
    };
    ...
    "electron-to-chromium-1.3.141" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.3.141";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.141.tgz";
        sha512 = "DdQaeP8yQNYFdivOrp37UNAZMvyZP//+SWYMVJD31A/3gbI1J6olQs8tuRaHL2ij7dubhCDXhlE4F97mrT8KGQ==";
      };
    };
    "elliptic-6.4.1" = {
      name = "elliptic";
    ...
    "i18n-js-3.2.2" = {
      ...
      version = "3.2.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/i18n-js/-/i18n-js-3.2.2.tgz";
        sha512 = "CSTJelBrTDa54Utpj5BNEcplB4i/kXytjVNdQe4k/OQv1r9rVHtRZHWnhvRwkOrhdeJn7Wt05cv/rj5UT9Efhg==";
      };
    };
    "iconv-lite-0.4.24" = {
      name = "iconv-lite";
    ...
    "realm-2.28.0" = {
      ...
      version = "2.28.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/realm/-/realm-2.28.0.tgz";
    ...
    "web3-git+https://github.com/status-im/web3.js.git#0.20.2-status" = {
      ...
      src = fetchgit {
        ...
        rev = "958dbabff2c77615e23f5de678a6fae0b0d70147";
        sha256 = "2d1e9f0a7463abc052cb6c64c1007926967bb08a52733200c4270f426400fab4";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."@react-native-community/cli-1.9.7" // {
        dependencies = [
      ...
      sources."electron-to-chromium-1.3.141"
      ...
      sources."react-native-udp-git+https://github.com/status-im/react-native-udp.git#2.3.1-1"
      ...
      (sources."web3-git+https://github.com/status-im/web3.js.git#0.20.2-status" // {
        dependencies = [
          sources."bignumber.js-git+https://github.com/status-im/bignumber.js.git#v4.0.2-status"
        ];
      })
