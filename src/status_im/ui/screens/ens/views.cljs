...
(defn- input-icon [{:keys [state] :as props} usernames]
  (cond
    ...
    (valid-domain? state)
    (let [full-username (full-username props)]
      (if (contains? (set usernames) full-username)
